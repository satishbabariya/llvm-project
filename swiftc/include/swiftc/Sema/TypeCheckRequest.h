...
#ifndef SWIFTC_SEMA_TYPE_CHECK_REQUEST_H
#define SWIFTC_SEMA_TYPE_CHECK_REQUEST_H
...
#include "swiftc/Sema/TypeCheckRequestKinds.def"
  } TheKind;
...
#include "swiftc/Sema/TypeCheckRequestPayloads.def"
  } Payload;
