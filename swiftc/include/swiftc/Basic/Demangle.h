...
#ifndef SWIFTC_BASIC_DEMANGLE_H
#define SWIFTC_BASIC_DEMANGLE_H
...
#define VALUE_WITNESS(MANGLING, NAME) \
  NAME,
#include "swiftc/Basic/ValueWitnessMangling.def"
};
...
#define NODE(ID) ID,
#include "swiftc/Basic/DemangleNodes.def"
  };
