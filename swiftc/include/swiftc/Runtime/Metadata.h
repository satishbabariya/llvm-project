...
#include "swiftc/RemoteInspection/Records.h"
#include "swiftc/Runtime/Once.h"
#include "swiftc/shims/Visibility.h"
...
#define BUILTIN_POINTER_TYPE(Symbol, _) \
  SWIFT_RUNTIME_EXPORT const ValueWitnessTable VALUE_WITNESS_SYM(Symbol);
#include "swiftc/Runtime/BuiltinTypes.def"
...
#include "swiftc/Demangling/StandardTypesMangling.def"
};
