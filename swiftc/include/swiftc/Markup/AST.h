...
//===----------------------------------------------------------------------===//
//
#ifndef SWIFTC_MARKUP_AST_H
#define SWIFTC_MARKUP_AST_H
...
#include "swiftc/Markup/ASTNodes.def"
...
public:
  ...
  ArrayRef<const MarkupASTNode *> getChildren() const { return {}; }
  ArrayRef<MarkupASTNode *> getChildren() { return {}; }
...
public:
  ...
  Optional<CommentParts> getParts() const {
    return Parts;
  }
...
#include "swiftc/Markup/SimpleFields.def"
