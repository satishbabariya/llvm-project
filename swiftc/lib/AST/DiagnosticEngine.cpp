...
#include "swiftc/AST/DiagnosticsCommon.h"
...
#include "swiftc/Localization/LocalizationFormat.h"
...
#include "swiftc/AST/DiagnosticsAll.def"
  NumDiags
};
...
#define EDUCATIONAL_NOTES(DIAG, ...)                                           \
  static constexpr const char *const DIAG##_educationalNotes[] = {__VA_ARGS__, \
                                                                  nullptr};
#include "swiftc/AST/EducationalNotes.def"
